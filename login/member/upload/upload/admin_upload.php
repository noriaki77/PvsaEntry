...
if ($order == "") {
$sql = "SELECT id,number,title,filename FROM upload";
} else {
...
//for($i=0; $i<$num; $i++) {
 print("<TH>登録No.<a href=\"admin_upload.php?order=".$order1."\">▼</a><a href=\"admin_upload.php?order=".$order2."\">▲</a></TH>");
 print("<TH>受付番号</TH>");
 print("<TH>タイトル</TH>");
 print("<TH>ファイル名</TH>");
//}
...
//while($row = mysql_fetch_array($result)) {
  ...
  //for($j=3; $j<$num+1; $j++) {
    print("<TD><a href=\"upload/upload/".$row[3]."\">".$row[3]."</a></TD>");
  //}
  print("</TR>");
