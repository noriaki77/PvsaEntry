...
if ( get_magic_quotes_gpc() ) {
  $data28 = stripslashes( $data28 );
		...
		$data29 = $db_value[27] ;
		//add to the database
		$result_sql = mysql_query("INSERT INTO data VALUES (NULL,NULL,'$data0','$data1','$data2','$data3','$data4','$data5','$data6','$data7','$data8','$data9','$data10','$data11','$data12','$data13','$data14','$data15','$data16','$data17','$data18','$data19','$data20','$data21','$data22','$data23','$data24','$data25','$data26','$data27','$data28','$data29')");
		$no = mysql_insert_id();
		if (!$result_sql) {
	...
	// -------------------------------------------------------
	$id = $_POST['list'];
	$sql4 = "SELECT * FROM users_ref "; // SQL文
	$sql4.= "WHERE id = '" . $id . "'";
