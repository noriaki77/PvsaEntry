...
<FORM method="POST" enctype="multipart/form-data" action="form_summary.php">
...
print("<FORM method='POST' enctype='multipart/form-data' action='form/index.php'>");
...
<?php
if($_POST){
print("<p><center><input type='submit' value='参加登録申込'></center></p>");
print("</FORM>");
}else{
print("<FORM method='POST' enctype='multipart/form-data' action='form/index.php'>");
print("<p><center><input type='submit' value='参加登録申込'></center></p>");
