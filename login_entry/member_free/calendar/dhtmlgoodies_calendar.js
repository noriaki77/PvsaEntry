...
*/
var languageCode = 'ja';	// Possible values: 	en,ge,no,nl,es,pt-br,fr
							// en = english, ge = german, no = norwegian,nl = dutch, es = spanish, pt-br = portuguese, fr = french, da = danish, hu = hungarian(Use UTF-8 doctype for hungarian)

var calendar_display_time = true;

var start_week = 0; // カレンダー表示の開始曜日を指定(0=Sun,1=Mon,...6=Sat)
...
function writeCalendarContent()
{
	...
	// MOD:ja
	if (dayStartOfMonth==start_week) {
		dayStartOfMonth=0;
	} else if (dayStartOfMonth-start_week<0) {
		dayStartOfMonth=7-start_week;
	}
	...
	// MOD:ja
	for (var no=start_week;no<(dayArray.length+start_week);no++) {
		var cell = row.insertCell(-1);
	...
	for(var no=1;no<=daysInMonth;no++){
		...
		if(colCounter>0 && colCounter%7==0){
			...
			//var cell = row.insertCell(-1);
			//cell.className = 'calendar_week_column';
			//var week = getWeek(currentYear,currentMonth,no+1);
			//cell.innerHTML = week;		// Week
			//cell.style.backgroundColor = selectBoxRolloverBgColor;
