...
<!--パンくずリストここから-->
<div class="pan"><a href="../index.php">トップ</a> ＞ ファイルアップ</div>
<!--パンくずリストここまで-->
			...
			<form action="upload_file.php" method="post" enctype="multipart/form-data">
				<div class="section">
					...
					<table style="width:80%;">
						<tr>
							<th width="35%">ユーザID<span class="red">*</span></th>
							<td>
						...
						<tr>
							...
							<td>
								<input type="text" name="number" value="<?php echo $_SESSION["number"]; ?>" size="10" />
							</td>
						</tr>
						<tr>
