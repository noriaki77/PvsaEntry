...
$result = mysql_query('SELECT * FROM nwuxnz_edit_temp_2');
...
<TR><TD>会社名: </TD><TD><input type="text" name="t2" value="<?php print $star2; ?>"></TD></TR>
...
<TR><TD>参加者名 [ 1 ]: </TD><TD><input type="text" name="t9" value="<?php print $star9; ?>"></TD></TR>
<TR><TD>参加者名 [ 2 ]: </TD><TD><input type="text" name="t10" value="<?php print $star10; ?>"></TD></TR>
<TR><TD>参加者名 [ 3 ]: </TD><TD><input type="text" name="t11" value="<?php print $star11; ?>"></TD></TR>
<TR><TD>参加者名 [ 4 ]: </TD><TD><input type="text" name="t12" value="<?php print $star12; ?>"></TD></TR>
<TR><TD>参加者名 [ 5 ]: </TD><TD><input type="text" name="t13" value="<?php print $star13; ?>"></TD></TR>
</table>
